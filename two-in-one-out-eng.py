...
# evaluate model
print(generate_seq(model, tokenizer, max_length-1, 'Rabbit ran', 5))
print(generate_seq(model, tokenizer, max_length-1, 'Snail did', 3))
print(generate_seq(model, tokenizer, max_length-1, 'walked quietly', 5))
print(generate_seq(model, tokenizer, max_length-1, 'so loudly', 5))